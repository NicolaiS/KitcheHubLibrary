...
public class KHSchemaDatasourceContainer extends KHSchema {
	...
	public static final String SQL_CREATE = "CREATE TABLE " + TABLE_NAME + " ("
			...
			+ CN_DATA_SOURCE_ID + INTEGER_TYPE + COMMA_SEP
			+ CN_CONTAINER_ID + INTEGER_TYPE + COMMA_SEP
			+ CN_ANTENNA + INTEGER_TYPE + COMMA_SEP
			+ FK_1 + CN_DATA_SOURCE_ID + FK_2 + KHSchemaDataSource.TABLE_NAME + FK_3 + KHSchemaDataSource.CN_ID + FK_4 + COMMA_SEP
	...
	public static final String[] PROJECTION_ALL = { CN_ID, CN_DATA_SOURCE_ID,
			CN_CONTAINER_ID, CN_ANTENNA };
}